...
*   **🍎 豐盛的 12 種三牲四果供品**
    *   內嵌 12 種極具台灣傳統祭祀與年節特色之向量 SVG 供品：
        *   **葷食三牲**：熟全雞、全魚、三層肉
        *   **時令水果**：鳳梨、紅蘋果、吉利橘、水梨
        *   **年節糕點**：紅龜粿、發粿、草仔粿、壽桃
        *   **清香花卉**：敬神鮮花
    *   滑鼠點選後，供品將以「漸顯與微幅下沉」的彈性動畫（Bounce Cubic-bezier）置入神桌的 **7 個前後排專屬插槽**（後排 4 位放置素果糕點，前排 3 位放置葷食三牲，重現傳統禮俗），點擊桌上供品可隨時撤收。
...
*   **📱 完美響應式佈局 (RWD)**
    ...
    *   「供品擺放選單」改置於畫面正下方，橫向平鋪方便操作。在手機或直式螢幕下，核心祭祀區（神桌與牌位）會自動置頂，控制面板、選單與金爐區向下延伸，保持最佳視覺比例，防止元素錯位。
...
*   [LICENSE](file:///home/kenny/Git_KennySpace/Virtual-ancestor-worship/LICENSE) - MIT 授權宣告條款
